...
const CATS = [{
  ...
  id: "papers",
  label: "Past papers",
  blank: "IEB papers and memos you've collected. Upload them here."
}, {
  id: "prelims",
  label: "Other schools' prelims",
  blank: "Prelim papers from other IEB schools. Upload what you get hold of."
}, {
  id: "tips",
  label: "Tips & links",
  blank: ""
...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    fileInput: fileInput,
    onFiles: upload,
    files: files.filter(f => f.subject_id === subject.id && f.cat === view.cat),
    onOpen: openFile,
    onPrint: printFile,
    onDownload: downloadFile,
    onDelete: removeFile
...
function FilesPanel({
  ...
  return /*#__PURE__*/React.createElement("div", null, (cat === "papers" || cat === "prelims") && /*#__PURE__*/React.createElement("div", {
  ...
  }, "up to 50 MB per pdf")), /*#__PURE__*/React.createElement("div", {
...
function TipsPanel({
  ...
  }, "Save tip"))), /*#__PURE__*/React.createElement("ul", {
  ...
  }, "No tips saved yet. Add the ones your teacher repeats."))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Eyebrow, null, "Links"), /*#__PURE__*/React.createElement("div", {
